...
//
//public class YmlService extends Database {
//
...
//        if(!DB.pendingInvitesMap.containsKey(uuid)) {
//            pendingInvites.add(townName);
//        }else{
//            pendingInvites = DB.pendingInvitesMap.get(uuid);
//            pendingInvites.add(townName);
//        }
//        DB.pendingInvitesMap.put(uuid,pendingInvites);
//        System.out.println(DB.pendingInvitesMap.get(uuid).size());
//    }
//
//    @Override
//    public List<String> getPendingInvites(String uuid) {
//        System.out.println("Condition 1: " + !DB.pendingInvitesMap.containsKey(uuid));
//        System.out.println("Condition 2: " + (DB.pendingInvitesMap.containsKey(uuid) && DB.pendingInvitesMap.get(uuid).size() <= 0));
//
//        if(!DB.pendingInvitesMap.containsKey(uuid) || (DB.pendingInvitesMap.containsKey(uuid) && DB.pendingInvitesMap.get(uuid).size() <= 0))
//            return null;
//        return DB.pendingInvitesMap.get(uuid);
//    }
//
//    @Override
...
//            return;
//
//        List<String> lstPending = DB.pendingInvitesMap.get(uuid);
//        if(!lstPending.contains(townName))
//            return;
//        lstPending.remove(townName);
//        DB.pendingInvitesMap.put(uuid,lstPending);
//    }
//}
